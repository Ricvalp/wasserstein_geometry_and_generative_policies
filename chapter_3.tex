...
On a finite-dimensional Riemannian manifold, \explanationlink{riemannian_gradient_descent}{gradient descent is defined by using the metric to convert the differential of an objective into a vector field}.
...
\log \rho +1.
\]
A \prooflink{entropy_first_variation}{proof of this first-variation computation}
